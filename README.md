...
In order to work, each individual action runner needs to have a unique label (ie. mac-1, mac-2 etc). Here, we presume that all the runners are similiar computers; Apple Silicon Mac minis.
